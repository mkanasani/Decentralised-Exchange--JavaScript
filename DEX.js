const serverUrl = "https://bxmlxyt9vxs1.usemoralis.com:2053/server";
const appId = "Xtb30U3wcEkGp0kFL5UOlryXJElKObsA50fVqVTg";
Moralis.start({ serverUrl, appId });

Moralis
    .initPlugins()
    .then(() => console.log('Plugins have been initialised'));
...
async function formSubmitted(event) {
    ...
    const fromTokenAddress = $selectedToken.dataset.decimals;
    ...
    try {
            ...
            document.querySelector('.js-quote-container').innerHTML = `
            <p class="error"> The conversion is not possible. </p>
            `;
    }
}
